...
namespace FastColoredTextBoxCore
{
    public class SyntaxHighlighter : IDisposable
    {
        //styles
        protected static readonly Platform platformType = PlatformType.GetOperationSystemPlatform();
        public readonly Style BlueBoldStyle = new TextStyle(new SolidBrush(Color.FromArgb(15, 84, 214)), null, FontStyle.Bold);
        public readonly Style BlueStyle = new TextStyle(new SolidBrush(Color.FromArgb(15, 84, 214)), null, FontStyle.Regular);
        public readonly Style BoldStyle = new TextStyle(new SolidBrush(Color.FromArgb(107, 47, 186)), null, FontStyle.Regular);
        public readonly Style BrownStyle = new TextStyle(new SolidBrush(Color.FromArgb(140, 108, 65)), null, FontStyle.Italic);
        public readonly Style GrayStyle = new TextStyle(Brushes.Gray, null, FontStyle.Regular);
        public readonly Style GreenStyle = new TextStyle(new SolidBrush(Color.FromArgb(36, 135, 0)), null, FontStyle.Italic);
        public readonly Style MagentaStyle = new TextStyle(new SolidBrush(Color.FromArgb(171, 47, 107)), null, FontStyle.Regular);
        public readonly Style MaroonStyle = new TextStyle(new SolidBrush(Color.FromArgb(133, 0, 61)), null, FontStyle.Regular);
        public readonly Style RedStyle = new TextStyle(Brushes.Red, null, FontStyle.Regular);
        public readonly Style BlackStyle = new TextStyle(new SolidBrush(Color.FromArgb(56, 56, 56)), null, FontStyle.Regular);
        public readonly Style MethodStyle = new TextStyle(new SolidBrush(Color.FromArgb(0, 133, 95)), null, FontStyle.Regular);
        //
        ...
        protected Regex CSharpLinqExtensionsRegex;
        ...
        protected void InitCShaprRegex()
        {
            ...
            CSharpLinqExtensionsRegex =
                new Regex(
                    @"\b(Where|OfType|OrderBy|OrderByDescending|ThenBy|ThenByDescending|GroupBy|Join|GroupJoin|Select|SelectMany|All|Any|Contains|Aggregate|Average|Count|Max|Min|Sum|ElementAt|ElementAtOrDefault|First|FirstOrDefault|Last|LastOrDefault|Single|SingleOrDefault|SequenceEqual|Concat|DefaultIfEmpty|Empty|Range|Repeat|Distinct|Except|Intersect|Union|Skip|SkipWhile|Take|TakeWhile|AsEnumerable|AsQueryable|Cast|OfType|ToArray|ToDictionary|ToList|ToLookup)\b",
                    RegexCompiledOption);
...
";
            ...
            range.SetStyle(FunctionsStyle, CSharpLinqExtensionsRegex);
...
";
        ...
        protected void InitSQLRegex()
        {
            ...
            SQLKeywordsRegex = new Regex(@"\b(ADD|ALL|AND|ANY|AS|ASC|AUTHORIZATION|BACKUP|BEGIN|BETWEEN|BREAK|BROWSE|BY|CASCADE|CHECK|CHECKPOINT|CLOSE|CLUSTERED|COLLATE|COLUMN|COMMIT|COMPUTE|CONSTRAINT|CONTAINS|CONTINUE|CROSS|CURRENT|CURRENT_DATE|CURRENT_TIME|CURSOR|DATABASE|DBCC|DEALLOCATE|DECLARE|DEFAULT|DENY|DESC|DISK|DISTINCT|DISTRIBUTED|DOUBLE|DUMP|ELSE|END|ERRLVL|ESCAPE|EXCEPT|EXISTS|EXIT|EXTERNAL|FETCH|FILE|FILLFACTOR|FIRST|FOR|FOREIGN|FREETEXT|FULL|FUNCTION|GOTO|GRANT|GROUP|HAVING|HOLDLOCK|IDENTITY|IDENTITY_INSERT|IDENTITYCOL|IF|INDEX|INNER|INTERSECT|IS|JOIN|KEY|KILL|LIKE|LINENO|LOAD|NATIONAL|NOCHECK|NEXT|NONCLUSTERED|NOT|NULL|OF|OFF|OFFSETS|ON|ONLY|OPEN|OR|ORDER|OUTER|OVER|PERCENT|PIVOT|PLAN|PRECISION|PRIMARY|PRINT|PROC|PROCEDURE|PUBLIC|RAISERROR|READ|READTEXT|RECONFIGURE|REFERENCES|REPLICATION|RESTORE|RESTRICT|RETURN|REVERT|REVOKE|ROLLBACK|ROWCOUNT|ROWGUIDCOL|ROW|ROWS|RULE|SAVE|SCHEMA|SECURITYAUDIT|SHUTDOWN|SOME|STATISTICS|TABLE|TABLESAMPLE|TEXTSIZE|THEN|TO|TRAN|TRANSACTION|TRIGGER|TSEQUAL|UNION|UNIQUE|UNPIVOT|UPDATETEXT|USE|USER|VALUES|VARYING|VIEW|WAITFOR|WHEN|WHILE|WRITETEXT)\b", RegexOptions.IgnoreCase | RegexCompiledOption);
